...
(function () {
  try {
    ...
    document.addEventListener('click', function (e) {
      ...
      if (/^sms:/i.test(href))                     ev('cta', 'sms-click');
      else if (/js-share/.test(a.className || ''))  ev('cta', 'share-friend');
      else if (/js-addcal/.test(a.className || '')) ev('cta', 'add-calendar');
      else if (href.indexOf('#sign') !== -1)       ev('cta', 'click-sign-nav');
